...
| `Form`                                                                                                  | Generic Convex mutation form driven by `FieldConfig`; owns native validation, pending state, toast handling, R2 upload/cleanup, and optional `prepareArgs`.     |
