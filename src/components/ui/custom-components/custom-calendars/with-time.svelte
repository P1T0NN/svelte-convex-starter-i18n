	...
	<Card.Content class="relative p-0 md:pe-48">
		<div class="p-6">
			<Calendar
				...
				class="**data-outside-month:hidden bg-transparent p-0 [--cell-size:--spacing(10)] data-unavailable:line-through data-unavailable:opacity-100 md:[--cell-size:--spacing(12)]"
				weekdayFormat="short"
			/>
		</div>
