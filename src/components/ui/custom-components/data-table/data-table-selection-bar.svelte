...
>
	<span class="flex items-center gap-2.5 text-sm">
		...
		<span class="text-muted-foreground">{m['Components.DataTableSelectionBar.selected']()}</span>

		<Plural
			{count}
			forms={{
				one: m['Components.DataTableSelectionBar.item'](),
				other: m['Components.DataTableSelectionBar.items']()
			}}
