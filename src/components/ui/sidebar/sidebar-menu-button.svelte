...
<script lang="ts">
	...
	type TooltipTriggerChildProps = Parameters<
		NonNullable<ComponentProps<typeof Tooltip.Trigger>['child']>
	>[0];
...
{#snippet Button({ props }: { props?: TooltipTriggerChildProps['props'] })}
